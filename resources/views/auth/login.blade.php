...
<head>
    ...
    <!-- Le styles -->
    <script type="text/javascript" src="http://zq.1i1l.com/myblog/public/Admin/assets/js/jquery.min.js"></script>

    <!--  <link rel="stylesheet" href="assets/css/style.css"> -->
    <link rel="stylesheet" href="http://zq.1i1l.com/myblog/public/Admin/assets/css/loader-style.css">
    <link rel="stylesheet" href="http://zq.1i1l.com/myblog/public/Admin/assets/css/bootstrap.css">
    <link rel="stylesheet" href="http://zq.1i1l.com/myblog/public/Admin/assets/css/signin.css">
    ...
    <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="http://zq.1i1l.com/myblog/public/Admin/assets/ico/minus.png">
</head>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="account-box">
                    <form method="POST" action="http://zq.1i1l.com/myblog/public/login">
                        {!! csrf_field() !!}
                    ...
                    <div class="or-box">
                        ...
                        <center><span class="text-center login-with">Login or <a href="http://zq.1i1l.com/myblog/public/register"><b>Sign Up</b> </a> </span></center>
                        <div class="row">
                    ...
                    <div class="row-block">
                        <div class="row">
                            <div class="col-md-12 row-block">
                                <a href="http://zq.1i1l.com/myblog/public/register" class="btn btn-primary btn-block">Create New Account</a>
                            </div>
                        </div>
                    </div>
                    <div class="row-block">
