        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="account-box">
                    ...
                    <div class="or-box">
                        <center><span class="text-center login-with"><a href="http://zq.1i1l.com/myblog/public/auth/login"><b> Login</b></a> or Sign Up</span></center>
                    </div>
                        {{--<div class="or-box">--}}
...
<!-- MAIN EFFECT -->
<script type="text/javascript" src="{{asset('Admin/assets/js/preloader.js')}}"></script>
