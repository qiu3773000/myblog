                        ...
                        @if (!empty($artList->toArray()['get_article']))
                            ...
                            @foreach( $artList->toArray()['get_article'] as $key => $item)
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
                                        ...
                                        <h4 class="title"><a href="http://zq.1i1l.com/myblog/public/detail/{{$item['id']}}/">{{$item['title']}}</a></h4>

                                        <p><time datetime="{{$item['created_at']}}"><a href="http://zq.1i1l.com/myblog/public/detail/{{$item['id']}}/">{{$item['created_at']}}</a></time></p>
                                    </div>
                                @if (($key + 1)%4 == 0)
