    ...
    <table id="responsive-example-table" class="table large-only table-hover " >
        ...
        @foreach($link as $item)
            <tr class="">
                ...
                <td>{{$item['ordering']}}</td>
                <td>
                    <form action="http://zq.1i1l.com/myblog/public/link/{{$item['id']}}" method="post">
                        <a href="http://zq.1i1l.com/myblog/public/link/{{$item['id']}}" style="margin-left:10px;"  class=" btn btn-info " title="友链修改"><span class="entypo-pencil"></span>&nbsp;&nbsp;修改</a>
