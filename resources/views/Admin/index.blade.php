        ...
        <div class="col-sm-4">
            <ul class="list-group">
                ...
                <li class="list-group-item text-center">
                    <img src="http://zq.1i1l.com/myblog/public/Admin/assets/img/logo.png" alt="" style="width: 20%;height: 20%" class="img-circle img-responsive img-profile">
                ...
                <li class="list-group-item text-right">
                    <span class="pull-left">
                    <strong>运行环境</strong>
                    </span>{{$_SERVER['SERVER_SOFTWARE'] }}
                </li>
                <li class="list-group-item text-right">
                    <span class="pull-left">
                    <strong>上传附件限制</strong>
                    </span>{{strtoupper(ini_get('upload_max_filesize')) }}
                </li>
                ...
                <div class="body-nest" id="header">
                    ...
                    <script type="text/javascript">
                        ...
                        (function() {
                            ...
                            ds.src = 'https://unpkg.com/embed-js';
                            ds.charset = 'UTF-8';
