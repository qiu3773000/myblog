    ...
    <table id="responsive-example-table" class="table large-only table-hover " >
        ...
        <tbody>
            @foreach($category as $item)
                ...
                <td>
                    <form action="http://zq.1i1l.com/myblog/public/category/{{$item['id']}}" method="post">
                        <a href="http://zq.1i1l.com/myblog/public/category/{{$item['id']}}" style="margin-left:10px;"  class=" btn btn-info " title="分类修改"><span class="entypo-pencil"></span>&nbsp;&nbsp;修改</a>
