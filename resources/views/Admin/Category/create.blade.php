...
@section('css')
    <link href="{{asset('Admin/assets/js/validate/validate.css')}}" rel="stylesheet">
    @endsection
...
@section('content')
    <div class="body-nest" id="element">
        ...
        <div class="panel-body">
            <form method="post" action="http://zq.1i1l.com/myblog/public/category" class="form-horizontal bucket-form createForm">
                {!! csrf_field() !!}
