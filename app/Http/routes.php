...
Route::group(['middleware' => 'auth'],function(){
    ...
    //修改密码
    Route::get('update_pwd', 'Home\IndexController@updatePwd');
...
//注册
    ...
    Route::post('update_pwd', 'Home\IndexController@updatePwd');//修改密码
    Route::post('update_bg', 'Home\IndexController@updateBg');//修改背景图片
